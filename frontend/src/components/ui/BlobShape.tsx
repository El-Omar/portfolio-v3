export default function BlobShape() {
  return (
    <div className="absolute -z-10 xl:-top-[300px] xl:-right-[300px] xl:w-[1000px] xl:h-[1000px] lg:-top-[200px] lg:-right-[200px] lg:w-[700px] lg:h-[700px] -top-[150px] -right-[150px] w-[500px] h-[500px]">
      <svg
        viewBox="0 0 400 400"
